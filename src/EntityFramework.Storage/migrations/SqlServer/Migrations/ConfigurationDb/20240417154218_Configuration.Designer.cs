...
namespace SqlServer.Migrations.ConfigurationDb
{
    ...
    [Migration("20240417154218_Configuration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.Client", b =>
                {
                    b.HasOne("IdentityServer4.EntityFramework.Entities.Tenant", "Tenant")
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.IdentityResource", b =>
                {
                    b.HasOne("IdentityServer4.EntityFramework.Entities.Tenant", "Tenant")
                        .WithMany("TenantIdentityResources")
                        .HasForeignKey("TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.Tenant", b =>
                {
                    ...
                    b.Navigation("TenantIdentityResources");
                });
